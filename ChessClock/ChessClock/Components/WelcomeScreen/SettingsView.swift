                ...
                HStack {
                    Button(action: {
                        ...
                        Text("On")
                            ...
                            .background(colorScheme == "Default" ? sound ? Color("LightGreen") : Color("Pale")  : sound ? .white : .black)
                            .cornerRadius(10)
                    ...
                    Button(action: {
                        ...
                        Text("Off")
                            ...
                            .font(.custom("InterTight-SemiBold", size: 18))
                            .frame(width: UIScreen.main.bounds.width / 3.5, height: UIScreen.main.bounds.height / 14)
                            .background(colorScheme == "Default" ? sound ? Color("Pale") : Color("LightGreen")  : sound ? .black : .white)
                            .cornerRadius(10)
